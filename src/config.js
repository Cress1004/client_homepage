...
export const MANAGER_APP_URL = process.env.NODE_ENV === 'production' ? process.env.REACT_APP_HEROKU_MANAGER_PAGE_URL : process.env.REACT_APP_LOCAL_MANAGER_PAGE_URL